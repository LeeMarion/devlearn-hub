...
<body>
    ...
    <div class="main">
        <h2>PHP Conditions and If Statements</h2>
        ...
        <h2>The if Statement</h2>
            <p>Use the if statement to specify a block of PHP code to be executed if a condition is true.</p>
            <h3>Syntax:</h3>
            <p>if (condition) {</p>
