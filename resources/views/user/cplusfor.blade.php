...
<body>
    ...
    <div class="main">
        ...
        <h2>The foreach Loop</h2>
            <p>There is also a "for-each loop" (introduced in C++ version 11 (2011), which is used exclusively to loop through elements in an array (or other data sets):</p>
            <h3>Syntax:</h3>
