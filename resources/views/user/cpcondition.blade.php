...
<body>
    ...
    <div class="main">
        ...
        <p>Conditional statements, like the if-else statement in C++, control program flow based on conditions. The if-else syntax consists of an initial condition followed by code blocks for true and false outcomes. It enables executing different code paths depending on whether a condition evaluates to true or false.</p>
        <p>You have already learned that C supports the usual logical conditions from mathematics:</p>
        ...
        <h2>The if Statement</h2>
            ...
            <h3>Example:</h3>
            <p>if (20 > 18) {</p>
                <p>printf("20 is greater than 18");</p>
                <p>}</p>
            <h3>Output:</h3>
